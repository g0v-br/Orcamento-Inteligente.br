...
<script>
  ...
  function fetchData(app) {
        ...
        let 
        tableView = bgoStore.any(undefined, ns.rdf('type'), ns.bgo('TableView')),
        ...
        app.headers.push({text: bgoStore.anyValue(tableView, ns.bgo('headerTitle')), value: 'title', width: "45%"});
        app.headers.push({text: bgoStore.anyValue(tableView, ns.bgo('headerAmount')), value: 'amount', width: "15%", filter: () => true}); //unserachable
        app.headers.push({text: bgoStore.anyValue(tableView, ns.bgo('headerTrend')), value: 'trend', width: "15%", filter: () => true}); //unsearchable
        app.headers.push({text: bgoStore.anyValue(tableView, ns.bgo('headerDescription')), value: 'description', width: "25%"});
